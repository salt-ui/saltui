/**
 * SelectField Component Demo for SaltUI
 * @author caoke.ck
 *
...
const monthArray = [
  ...
  { value: 6, text: '七月七月七月七月七月七月七月' }, { value: 7, text: '八月' },
        ...
        <Group>
          ...
          <Group.List>
            <SelectField
              ...
              placeholder="请输入"
            />
            <SelectField icon={<AngleRight />} label="有默认值" options={monthArray} onSelect={t.handleChange1.bind(t)} value={t.state.value1} tip="这里是tip" />
