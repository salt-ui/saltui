    ...
    return (
      <div>
        <Group>
          ...
          <Group.List>
            <SelectField icon={<AngleRight onClick={(e) => { e.stopPropagation(); alert('1'); }} />} readOnly={false} label="没有默认值" options={monthArray} onSelect={t.handleChange.bind(t)} value={t.state.value} placeholder="请输入" />
