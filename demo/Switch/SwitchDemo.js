    ...
    render() {
        return (
            <div className='demo'>
                ...
                <div className='demo-item'><label className='label-txt'>开关-disable-off</label><Switch on={this.state.on3} readOnly={true} onChange={this.handleChange.bind(this, "on3")}/></div>
                <div className='demo-item'><label className='label-txt'>开关-disable-on</label><Switch on={this.state.on4} readOnly={true} onChange={this.handleChange.bind(this, "on4")}/></div>
            </div>
        );
    }
}
