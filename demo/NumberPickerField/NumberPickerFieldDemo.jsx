  ...
  render() {
    ...
    return (
      <div>
        ...
        <NumberPickerField label="普通样式" step={0.1} min={-5} value={t.state.a} onChange={t.handleChange.bind(t, 'a')} />
        ...
        <NumberPickerField label="单个禁用样式" step={1} min={-5} value={t.state.f} max={1} readOnly onChange={t.handleChange.bind(t, 'f')} />
