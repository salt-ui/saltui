  ...
  _createClass(MonthTitle, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: prefixClass('day-calendar-month-title') },
...
MonthTitle.propTypes = {
  ...
  // 一个月中的任意一天都可以
  anyDayInMonth: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.string, _react2.default.PropTypes.number])
};
