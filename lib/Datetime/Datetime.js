...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getOptions = function (_ref, props) {
    ...
    var newValue = (0, _utils.formatFromProps)(_this2.formatText(ret.value), props);
    return {
      data: data,
      value: newValue
    };
  ...
  this.setOptions = function (props) {
    var _getOptions = _this2.getOptions({ value: props.value }, props),
  ...
  this.handleChange = function (value, column) {
    ...
    var newData = _this2.getOptions({ value: date }, props);
    var updateObj = {
      data: newData.data,
      value: newData.value
    };
