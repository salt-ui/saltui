...
function parseDate(_ref3) {
  ...
  var DateArr = [].concat(_toConsumableArray(dateStr.YMD), _toConsumableArray(dateStr.Hm));
  var currentValue = new (Function.prototype.bind.apply(Date, [null].concat(_toConsumableArray(DateArr))))();
  return currentValue;
}
...
function filterDate(_ref6) {
  ...
  var dayData = getDayByMonth({ year: year, month: month, minDate: minDate, maxDate: maxDate });
