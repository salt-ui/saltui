...
Dialog.propTypes = {
  transparentMode: _react2.default.PropTypes.bool, // 是否为透明背景
  // 弹窗头信息
  ...
  onConfirm: _react2.default.PropTypes.func, // 点击确认的回调事件
  onCancel: _react2.default.PropTypes.func, // 点击取消的回调事件
  type: _react2.default.PropTypes.string, // alert | confirm 添加默认 buttons
  ...
  btnDir: _react2.default.PropTypes.oneOf(['horizontal', 'vertical', '']), // 按钮排布方式
  show: _react2.default.PropTypes.bool, // 当前弹窗是否可见
  locale: _react2.default.PropTypes.string, // 语言信息
  confirmText: _react2.default.PropTypes.string, // 确认文字
  cancelText: _react2.default.PropTypes.string, // 取消文字
  transitionName: _react2.default.PropTypes.string, // 弹窗动画内容名称
  maskTransitionName: _react2.default.PropTypes.string, // 遮罩背景动画内容名称
  wrapClassName: _react2.default.PropTypes.string, // 弹窗容器 CSS 类名
  className: _react2.default.PropTypes.string // 弹窗内容 CSS 类名
};
