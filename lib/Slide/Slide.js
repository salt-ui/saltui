      ...
      return t.props.children.map(function (child, index) {
        ...
        return React.createElement(
          'div',
          {
            ...
            className: classnames((_classnames = {}, _defineProperty(_classnames, prefixClass('slide-item'), true), _defineProperty(_classnames, '' + prefixClass('slide-item') + t._getRealIndex(index), true), _classnames))
          },
          child
        );
      });
    ...
    value: function render() {
      ...
      return React.createElement(
        'div',
        {
          ...
          className: classnames((_classnames2 = {}, _defineProperty(_classnames2, prefixClass('slide'), true), _defineProperty(_classnames2, prefixClass('slide-off'), t.state.disabled), _defineProperty(_classnames2, prefixClass('slide-show-title'), showTitle), _defineProperty(_classnames2, prefixClass('slide-card-mode'), displayMode === 'card'), _defineProperty(_classnames2, t.props.className, !!t.props.className), _classnames2))
        },
        React.createElement(
          'div',
        ...
        t.props.showNav && t.length > 1 && React.createElement(SlideNav, {
